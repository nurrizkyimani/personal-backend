		...
		<nav>
			<ul className="flex  justify-between items-center px-8 py-2">
				...
				<ul className="flex justify-between items-center space-x-2 mr-3">
					...
					<li>
						<a href="#" class="inline-block text-sm py-2 pr-2  pl-1 leading-snug rounded-md text-gray-900  transition duration-300 ease-in-out  hover:bg-gray-200 mt-4 lg:mt-0">
							<div className="flex">
								<svg
									className="w-8 mr-2 "
